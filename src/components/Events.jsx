  ...
  return (
    <div className="relative w-full min-h-screen">
      ...
      <div className="h-screen flex flex-col items-center justify-center bg-black text-white text-5xl font-bold">
        ...
        <div style={{ height: '500px', position: 'relative' }} className='border-[1px] rounded-md border-zinc-600 mx-2'>
      ...
      <div className="px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
          {[
            {
              title: 'MCA', events: ['Capture the Flag', 'Code Relay', 'Tech Escape Room', 'Spot Mobile Photography'], no: ''
            },
            {
              title: 'ECE', events: ['Tech Clash', 'Locked in Logic', '3s Football', 'Mini Militia: Solo War'], no: ''
            },
            {
              title: 'Mechanical', events: ['Quiz', 'Engine Assembly', 'E-Football', 'Carrom'], no: ''
            },
            {
              title: 'EEE', events: ['Electrical Quiz', 'Circuit Identification & Soldering', 'Hands And Feet Hopscotch', 'Arm Wrestling'], no: ''
            },
            {
              title: 'CSE', events: ['Block of Code Arranging', 'Technical Quiz', 'BGMI Tournament', 'Valorant Tournament'], no: ''
            },
            {
              title: 'Civil', events: ['Bridge It Up', 'Movie Truffle', 'House of Cup', 'Technical Quiz'], no: ''
            }
          ].map((dept, index) => (
