...
const links = [
    { href: 'https://x.com/genshinimpact', icon: <FaTwitter /> },
    { href: 'https://www.youtube.com/c/GenshinImpact', icon: <FaYoutube /> },
    { href: 'https://www.instagram.com/genshinimpact', icon: <FaInstagram /> },
