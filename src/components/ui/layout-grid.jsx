...
export const LayoutGrid = ({
  ...
  return (
    (<div
      ...
      {cards.map((card, i) => (
        <div key={i} className={cn(card.className, "pb-4")}>
          <motion.div
...
const SelectedCard = ({
  ...
  return (
    (<div
      className="bg-transparent h-full w-full flex flex-col justify-end rounded-lg shadow-2xl relative z-[60] pb-4">
      <motion.div
        initial={{
          opacity: 0,
        }}
        ...
        className="absolute inset-0 h-full w-full bg-[#11111169] opacity-60 z-10" />
      <motion.div
